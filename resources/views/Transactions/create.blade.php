...
<div class="row">
    ...
    <div class="card-body">
        ...
        <form action="{{route('transactions.store')}}" method="POST">
            ...
            <button type="button" class="btn btn-primary btn-sm mb-3" onclick="addItem()">Tambah Item</button>
            ...
            <div class="d-flex justify-content-between">
                <button type="submit" class="btn btn-success btn-sm">Simpan Transaksi</button>
                <a href="{{ route('transactions.index') }}" class="btn btn-secondary btn-sm">Batal</a>
            </div>
